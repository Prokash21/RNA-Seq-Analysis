...
setwd("E:/DWCT/DEG/GSE219036_6_june/colon organoids/vs_mock/vs_mock/I_vs_mock")
...
ggplot(resLFC,aes(x = log2FoldChange, y = -log10(padj))) +
  ...
  labs(
    title = "Volcano of Treatment_MPXV.clade.I.infected_vs_mock", # Add the header here
    x = "Log2 Fold Change",
    y = "-log10(padj)",
    color = "Regulation"
  ) +
...
#"TAC1"       "CRYBB1"     "CRYBA1"     "EGR1"       "NR4A1"      "DNAJA4"     "TFF2"      
#[8] "TFF1"       "FABP1"      "DDIT4"      "FOS"        "JUNB"       "HSPA6"      "CRYBA4"    
#[15] "HIST1H4C"   "HSPA1A"     "CRYBB2"     "AL627171.2"

#top hits

#["HSPA5"    "AREG"     "ODC1"     "MT1G"     "MT2A"     "APOC1"    "AHSG"     "SLC7A7"  
#[9] "TFF1"     "FABP1"    "SPINK1"   "MT1E"     "FGG"      "FGA"      "FGB"      "ZG16"    
#[17] "A2M"      "SERPINA1" "MT1H"     "APOC2" 
#down

# ""MT1G"     "MT1B"     "MT1H"     "MT1M"     "CRIM1-DT"
