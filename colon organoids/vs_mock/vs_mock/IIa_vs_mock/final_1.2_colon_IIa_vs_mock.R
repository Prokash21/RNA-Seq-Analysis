...
setwd("E:/DWCT/DEG/GSE219036_6_june/colon organoids/vs_mock/vs_mock/IIa_vs_mock")
...
ggplot(resLFC,aes(x = log2FoldChange, y = -log10(pvalue))) +
  ...
  labs(
    title = "Volcano plot of Treatment_MPXV.clade.IIa.infected_vs_mock", # Add the header here
    x = "Log2 Fold Change",
    y = "-log10(P-Value)",
    color = "Regulation"
  ) +
...
# Save the filtered data to a CSV file
write.csv(top_gene_names1, file = "UP_p.value_all_hits_gene_names_IIa_vs_mock_20.csv", row.names = FALSE)
write.csv(top_gene_names, file = "UP_p.value_20_hits_gene_names_IIa_vs_mock_20.csv", row.names = FALSE)


#up

#[1] "EGR1"       "DNAJA4"     "FOS"        "HSPA6"      "HSPA1A"     "AL356488.2" "AL627171.2"

#top hits

#""ALDOC"      "AREG"       "HSPA8"      "CCN2"       "DUSP1"      "EGR1"       "KCNJ8"     
#[8] "ID1"        "ZFP36"      "DNAJB1"     "SLC7A7"     "ALDH1A1"    "FOS"        "HSPA6"     
#[15] "SERPINA3"   "HSPA1B"     "HSPA1A"     "GSTA1"      "GSTA2"      "AL627171.2"   
...
# Save the filtered data to a CSV file
write.csv(top_gene_names1, file = "DOWN_p.value_all_gene_names_IIa_vs_mock_20.csv", row.names = FALSE)
write.csv(top_gene_names, file = "DOWN_p.value_20_gene_names_IIa_vs_mock_20.csv", row.names = FALSE)
...
# Save the filtered data to a CSV file
write.csv(top_gene_names1, file = "UP_padj_all_hits_gene_names_IIa_vs_mock_20.csv", row.names = FALSE)
write.csv(top_gene_names, file = "UP_padj_20_hits_gene_names_IIa_vs_mock_20.csv", row.names = FALSE)
...
# Save the filtered data to a CSV file
write.csv(top_gene_names1, file = "DOWN_padj_all_gene_names_IIa_vs_mock_20.csv", row.names = FALSE)
write.csv(top_gene_names, file = "DOWN_padj_20_gene_names_IIa_vs_mock_20.csv", row.names = FALSE)
