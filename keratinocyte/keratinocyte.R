...
# Calculate log fold change for MPXV clade I infected vs. mock
contrast_results <- results(dds, contrast=c("Treatment", "MPXV clade I infected", "mock"))
contrast_results <- as.data.frame(contrast_results)
...
deseq_results0.05 <- results(dds, alpha = 0.05)
head(deseq_results0.05)

deseq_results0.01 <- results(dds, alpha = 0.01)
summary(deseq_results0.01)
deseq_results0.01
class(deseq_results0.01)
...
deseq_results0.01 <- as.data.frame(deseq_results0.01)
head(deseq_results0.01)
