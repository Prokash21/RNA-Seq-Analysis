...
pheatmap(sampleDistMatrix,clustering_distance_rows=sampledists,
         ...
         main = "Heatmap of sample-to-sample distance matrix for IIa_vs_I")
...
pheatmap(assay(rld)[top_hits, ], 
         ...
         fontsize_row = 8,
         annotation_col = df,
         main = "Heatmap of rld for TOP 20 genes_ids(IIa_vs_I)")
...
pheatmap(heatmap_data_ordered, 
         ...
         show_rownames = TRUE, 
         cluster_cols = FALSE,
         main = "Heatmap of rld for TOP 20 genes_names(IIa_vs_I)" )

pheatmap(heatmap_data_ordered,
         main= "Heatmap of rld for TOP 20 cluster(IIa_vs_I)")
...
DEresults <- results(dds, contrast = c("Treatment", "MPXV clade IIa infected", "MPXV clade I infected"))
