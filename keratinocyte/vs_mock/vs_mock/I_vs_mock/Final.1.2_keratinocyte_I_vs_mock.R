...
setwd("E:/DWCT/DEG/GSE219036_6_june/keratinocyte/vs_mock/vs_mock/I_vs_mock")
#load the count data
...
#Step 1: filter based on p adjusted value  5764
...
write.csv(resLFC_p_cut, file = "resLFC_p_cut.csv", row.names = TRUE)
